...
const TheHotelSEO = ({ title, description, showBrand }) => {
            ...
            <div>
                ...
                <div style={{ backgroundColor: '#151619' }}>
                    ...
                    <div className="container py-5">
                         ...
                         */}
                        <h3 style={{ color: "white" }} className="display-4 p-2">Professional Hotel SEO Agency to Increase Your Hotel Visibility and Bookings</h3>
                        <h2 style={{ color: "white" }} className="lead p-2">We provide hotel SEO services and specialize in search engine optimization for the hotel industry. Our speciality is creating customised hotel SEO strategy to raise the web presence of businesses. Being a reputable SEO agency for hotels, we provide first-rate hospitality SEO services that increase exposure and expansion in the highly competitive SEO hotel market.</h2>
                        <h2 style={{ color: "white" }} className="lead p-2">For almost ten years, we have offered hotel SEO services, boosting bookings, online presence, and leads. Many client successes have come from our reasonably priced and efficient hotel SEO strategies. Being a reputable hotel SEO consultant, we assist businesses in the demanding hotel SEO market to raise their online profile.</h2>
                                    ...
                                    <div data-aos="fade-left" data-aos-duration="1000" className="col-md-6 col-12">
                                        <div className="card border-0 shadow-0 pt-5 px-3" style={{ borderRadius: '0px', backgroundColor: 'inherit' }}>
                                            <p className='h1 mb-4 text-light' style={{ fontFamily: 'Sagrantino' }}>
                                                Why Choose Metatech For Your Hotel SEO Services?
                                            </p>
                                            <p className='text-light'>Choose Metatech for your hotel SEO needs since we offer customized strategies that improve online visibility, boost bookings, and strengthen the profile of your hotel, so guaranteeing long-term success in the highly competitive hotel industry.   </p>


                                            <ul className='text-light py-4'>
                                                <li><p className='p'>Our hotel SEO strategies are meant to increase the web presence and ranking of hospitality companies so as to efficiently reflect them.</p></li>
                                                <li><p className='p'>Reputable hotel SEO agency here provides first-rate hospitality SEO solutions to increase visibility in a crowded market.</p></li>
                                                <li><p className='p'>Our area of expertise is search engine optimization for hotels, providing customized plans improving internet presence and expansion.</p></li>
