...
const HotelSeo = ({ title, description, showBrand }) => {
            ...
            <div>
                ...
                <div style={{ backgroundColor: '#151619' }}>
                    ...
                    <div className="container py-5">
                         ...
                         */}
                        <h3 style={{ color: "white" }} className="display-4 p-2">Expert Travel SEO Services for Your Travel Agency Website</h3>
                        <h2 style={{ color: "white" }} className="lead p-2">Professional travel SEO company Metatech Official specializes in customized SEO services for websites, travel agencies, and the whole travel sector.</h2>
                        <h2 style={{ color: "white" }} className="lead p-2">By maximizing SEO for travel agents and businesses, our specialist strategies guarantee visibility and development. For more than ten years, we have been offering companies looking for more leads, more online visibility, and more sales SEO services. Many client success stories have come from our tested methods, which are reasonably priced.</h2>
                                    ...
                                    <div data-aos="fade-left" data-aos-duration="1000" className="col-md-6 col-12">
                                        <div className="card border-0 shadow-0 pt-5 px-3" style={{ borderRadius: '0px', backgroundColor: 'inherit' }}>
                                            <p className='h1 mb-4 text-light' style={{ fontFamily: 'Sagrantino' }}>
                                                Why Choose Metatech For Your Travel Agency SEO?
                                            </p>
                                            <p className='text-light'>Select Metatech for your travel agency SEO since we provide customized, professional solutions that increase visibility, stimulate development, and improve rankings, so differentiating your travel company in a crowded market.</p>


                                            <ul className='text-light py-4'>
                                                <li><p className='p'>Our travel SEO services concentrate on increasing visibility and growth, so enabling travel companies to raise their ranks and draw more business.</p></li>
                                                <li><p className='p'>We provide customised SEO services, optimising techniques especially for travel agents and businesses to boost visibility and leads.</p></li>
                                                <li><p className='p'>Metatech Official guarantees growth by specializing in expert SEO for travel agencies, travel websites, and the larger travel business.</p></li>
