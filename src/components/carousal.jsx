...
const Carousal = () => {
    ...
    const images = [{img:`${cdn}https://img.freepik.com/free-vector/dark-gradient-background-with-copy-space_53876-99548.jpg`,offer:'MACHINE LEARNING',icon:'fa-cube'},
    ...
    {offer:'SEARCH ENGINE OPTIMIZATION',icon:'fa-globe',img:`${cdn}https://img.freepik.com/free-vector/blurred-background-design_1107-219.jpg?w=740&t=st=1688421268~exp=1688421868~hmac=13b1d6e2247bc9f334ec09aa1ffd1e95e00864d84e47b7beea2ed4ee8c4105b4`}
    ]
                ...
                <div style={{paddingBottom:window.innerWidth>992?"52.941%":"133%"}} class="carousel-inner position-reltive">
                    <div style={{backgroundImage:`url(${images[0].img})`,top:"0"}} class="carousel-item active position-absolute">
                        ...
                        <div style={{ top: '0px', bottom: '0px', right: '0px', left: '0px' }} class="carousel-caption h-100 w-100 justify-content-center d-flex align-items-center flex-column">
                            ...
                            {images[counter].iconTwo&&<p className=' h1 display-1 mx-2' ><i class={`fa ${images[counter].iconTwo} fa-2x`}></i></p>}
                            
                            <p className='h1 display-1 mx-2' ><i class={`${images[counter].icon=='fa'?'fa':'fa'} ${images[counter].icon} fa-2x`}></i></p>
                            </div>
