                            ...
                            <div className="col-md-4 col-12 my-2">
                                <div class="card rounded-4 h-100 overflow-hidden" style={{ borderColor: "#6565ff" }}>
                                    ...
                                    <div className='pb-3 pt-4' style={{ borderRadius: '100%' }}>
                                        <p className='display-1 h1' ><i style={{ color: '#6565ff' }} class={`fa-solid fa fa-bed fa-xl`}></i></p>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <h2 class="card-title h5">Hotels SEO Services</h2>
                                        <p class="card-text">Our Hotel SEO company is providing search engine optimization for the hotel sector and professional local SEO for hotels. Our area of expertise is developing a hotel SEO plan specifically for the hotel sector, so providing excellent SEO solutions for hotels. Being a reputable hotel SEO agency, we assist to improve the online profile of your establishment.</p>
...
export default Thehotelseoservices