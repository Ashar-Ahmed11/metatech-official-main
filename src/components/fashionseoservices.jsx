                            ...
                            <div className="col-md-4 col-12 my-2">
                                <div class="card rounded-4 h-100 overflow-hidden" style={{ borderColor: "#6565ff" }}>
                                    ...
                                    <div className='pb-3 pt-4' style={{ borderRadius: '100%' }}>
                                        <p className='display-1 h1' ><i style={{ color: '#6565ff' }} class={`fa-solid fa fa-shopping-bag fa-xl`}></i></p>
                                    </div>
                                    <div class="card-body d-flex flex-column">
                                        <h2 class="card-title h5">Fashion SEO Services</h2>
                                        <p class="card-text">Our Fashion SEO team specializes in professional local SEO for fashion brands and search engine optimization for the fashion business. We are quite good in creating customized SEO plans especially for the fashion industry and providing excellent SEO solutions. Being a reputable Fashion SEO company, we assist to improve the online profile of your brand.</p>
...
export default FashionSEOServices